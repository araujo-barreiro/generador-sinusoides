...
HD_PWD=C:/Users/guill/Desktop/Practica7.xpr/Practica7/Practica7.runs/synth_1
cd "$HD_PWD"
...
EAStep vivado -log sistema_entero.vds -m64 -mode batch -messageDb vivado.pb -notrace -source sistema_entero.tcl
